@extends('layouts.base', ['title' => '|| Pricing Plan'])
                                    ...
                                    <div class="col-lg-5">
                                        <div class="price-area">
                                            ...
                                            <div class="button mt-30">
                                                <a class="theme-btn22" href="{{ route('second', ['pages', 'contact']) }}">Get Started <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
