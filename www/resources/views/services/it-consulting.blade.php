@extends('layouts.base', ['title' => '|| IT Consulting & Advisory Services'])
                            ...
                            <div class="_sidebar-widget _list mt-40">
                                ...
                                <div class="sidebar-list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('second', ['service', 'details2']) }}" class="active">IT Consulting <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
