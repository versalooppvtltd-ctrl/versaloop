@extends('layouts.base', ['title' => '|| Insurance Policy'])
                    ...
                    <div class="col-lg-12">
                        <article>
                            <div class="details-content">
                                <div class="image">
                                    <img class="w-full" src="/img/service/service-details7-image.png" alt="" />
                                </div>
                            </div>
                        </article>
                    </div>
                            ...
                            <div class="_sidebar-widget _list mt-40">
                                ...
                                <div class="sidebar-list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('second', ['service', 'details7']) }}" class="active">Insurance Policy <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
