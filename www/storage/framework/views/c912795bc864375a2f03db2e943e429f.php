                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service2-box mt-30 content-box">
                            <div class="with-content">
                                <div class="heading2">
                                    <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Social Media Strategy Development</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service2-box mt-30 content-box">
                            <div class="with-content">
                                <div class="heading2">
                                    <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Content Creation & Management</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service2-box mt-30 content-box">
                            <div class="with-content">
                                <div class="heading2">
                                    <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Paid Social Advertising</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service2-box mt-30 content-box">
                            <div class="with-content">
                                <div class="heading2">
                                    <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Social Media Analytics & Reporting</a></h4>
...
<?php echo $__env->make('layouts.base', ['title' => '|| Our Service V2'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/service/service2.blade.php ENDPATH**/ ?>