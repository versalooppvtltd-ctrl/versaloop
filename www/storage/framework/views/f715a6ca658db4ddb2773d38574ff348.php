                    ...
                    <div class="col-lg-8 mx-auto text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('root')); ?>" class="text-white">Home</a></li>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="list-group-item list-group-item-action">SEO Marketing</a>
                                        <a href="<?php echo e(route('second', ['service', 'details2'])); ?>" class="list-group-item list-group-item-action active">Social Media Strategy</a>
                                        <a href="<?php echo e(route('second', ['service', 'details3'])); ?>" class="list-group-item list-group-item-action">Content Marketing</a>
                                        <a href="<?php echo e(route('second', ['service', 'details4'])); ?>" class="list-group-item list-group-item-action">Pay-Per-Click Advertising</a>
                                        <a href="<?php echo e(route('second', ['service', 'details5'])); ?>" class="list-group-item list-group-item-action">Travel Guide Expertise</a>
                                        <a href="<?php echo e(route('second', ['service', 'details6'])); ?>" class="list-group-item list-group-item-action">HR Staffing Agency</a>
                                        <a href="<?php echo e(route('second', ['service', 'details7'])); ?>" class="list-group-item list-group-item-action">Insurance Policy</a>
                                        <a href="<?php echo e(route('second', ['service', 'details8'])); ?>" class="list-group-item list-group-item-action">Real Estate</a>
                                        <a href="<?php echo e(route('second', ['service', 'details9'])); ?>" class="list-group-item list-group-item-action">Startup Agency</a>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', ['title' => '|| Web Development Portfolio & Case Studies'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u521987573/domains/theseoppc.com/public_html/resources/views/services/web-development/portfolio.blade.php ENDPATH**/ ?>