                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Discover the emerging trends that are reshaping the startup ecosystem.</a></h4>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Learn the secrets to creating a brand that resonates with your audience.</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Mastering SEO: The Ultimate Guide to Boosting Website Traffic</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Content Marketing Tips to Elevate Your Brand’s Online Presence</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">The Power of Social Media Marketing: Strategies for Growth</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Data-Driven Insights: Using Analytics to Enhance Your Marketing Strategy</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Creating a Winning Content Strategy: Tips and Best Practices</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-11-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-11-content heading2">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">How to Measure SEO Success: Key Metrics to Track</a></h4>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.base', ['title' => '|| Our Blog'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/blogs/blog.blade.php ENDPATH**/ ?>