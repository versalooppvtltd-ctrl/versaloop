                ...
                <div class="col-lg-8 m-auto text-center">
                    <div class="white-heading">
                        ...
                        <div class="cta2-form">
                            ...
                            <div class="button">
                                <a class="theme-btn3" href="<?php echo e(route('second', ['pages', 'contact'])); ?>">Subscribe <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="vl-footer-widget-white2 mb-50 ml-20 md:ml-30 sm:ml-0">
                        ...
                        <div class="vl-footer-list">
                            <ul>
                                ...
                                <li><a href="<?php echo e(route('second', ['service', 'services'])); ?>">Services</a></li>
                                <li><a href="<?php echo e(route('second', ['blogs', 'blog'])); ?>">Blog</a></li>
                                <li><a href="<?php echo e(route('second', ['pages', 'contact'])); ?>">Contact Us</a></li>
                                <li><a href="<?php echo e(route('second', ['pages', 'testimonial'])); ?>">Testimonails</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/layouts/partials/footer.blade.php ENDPATH**/ ?>