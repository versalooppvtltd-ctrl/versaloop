                            ...
                            <div class="_sidebar-widget _list mt-40">
                                ...
                                <div class="sidebar-list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('second', ['service', 'details2'])); ?>" class="active">Cloud Services <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('second', ['service', 'details5'])); ?>">IT Consulting <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', ['title' => '|| Cloud Services'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u521987573/domains/theseoppc.com/public_html/resources/views/services/cloud-services.blade.php ENDPATH**/ ?>