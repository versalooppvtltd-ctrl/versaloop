                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="vl-header7-btns text-end d-none d-lg-block">
                        <div class="buttons">
                            ...
                            <a href="{{ route('second', ['pages', 'about']) }}" class="theme-btn13">Contact Us <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
