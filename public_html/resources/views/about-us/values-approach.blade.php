@extends('layouts.base', ['title' => '|| Our Values & Approach'])
                        ...
                        <div class="sidebar-area mt-50">
                            ...
                            <div class="_sidebar-widget _list mt-40">
                                ...
                                <div class="sidebar-list">
                                    <ul>
                                        <li>
                                            <a href="{{ route('second', ['about-us', 'our-story']) }}">Our Story <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="{{ route('second', ['about-us', 'values-approach']) }}" class="active">Values & Approach <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="{{ route('second', ['about-us', 'team']) }}">Our Team <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="{{ route('second', ['about-us', 'careers']) }}">Careers <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
