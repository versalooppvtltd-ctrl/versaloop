@extends('layouts.base', ['title' => '|| Our Service V1'])
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">HR Staffing</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">Web Design</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">Real Estate</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">Advertising</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">E-commerce</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">Travel Guide</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">Insurance</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            ...
                            <div class="content-area">
                                ...
                                <a href="{{ route('second', ['service', 'details1']) }}" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="{{ route('second', ['service', 'details1']) }}">Solar Energy</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
