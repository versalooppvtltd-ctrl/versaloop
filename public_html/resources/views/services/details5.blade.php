@extends('layouts.base', ['title' => '|| Travel Guide Expertise'])
                            ...
                            <div class="_sidebar-widget _list mt-40">
                                ...
                                <div class="sidebar-list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('second', ['service', 'details5']) }}" class="active">Travel Guide Expertise <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li>
