            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image5.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">05</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">HR Staffing</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image6.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">06</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Web Design</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image7.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">07</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Real Estate</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image8.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">08</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Advertising</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image9.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">09</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">E-commerce</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image10.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">10</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Travel Guide</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image11.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">11</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Insurance</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="/img/service/service5-image12.png" alt="" />
                            </div>
                            <div class="content-area">
                                <div class="num">12</div>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Solar Energy</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn3" href="<?php echo e(route('second', ['pages', 'about'])); ?>">View All Services <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
...
<?php echo $__env->make('layouts.base', ['title' => '|| Our Service V1'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/service/services.blade.php ENDPATH**/ ?>