                            ...
                            <div class="breadcrumbs-pages">
                                <ul style="list-style: none; padding: 0; display: flex; justify-content: center; flex-wrap: wrap;">
                                    <li style="margin: 0 10px;">
                                        <a href="<?php echo e(route('root')); ?>" style="color: white; text-decoration: none;">Home</a>
                                    </li>
                                ...
                                <div class="sidebar-list">
                                    <ul style="list-style: none; padding: 0;">
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">SEO Marketing <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details2'])); ?>" class="active" style="display: flex; justify-content: space-between; text-decoration: none; color: #333; font-weight: bold;">Social Media Strategy <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details3'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">Content Marketing <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details4'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">Pay-Per-Click Advertising <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details5'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">Travel Guide Expertise <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details6'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">HR Staffing Agency <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details7'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">Insurance Policy <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details8'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">Real Estate <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                        <li style="margin-bottom: 10px;">
                                            <a href="<?php echo e(route('second', ['service', 'details9'])); ?>" style="display: flex; justify-content: space-between; text-decoration: none; color: #333;">Startup Agency <span><i class="fa-solid fa-angle-right"></i></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.base', ['title' => '|| Social Media Strategy Development'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u521987573/domains/theseoppc.com/public_html/resources/views/services/mobile-app-development/maintenance-updates.blade.php ENDPATH**/ ?>