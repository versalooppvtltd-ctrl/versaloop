                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="text-end button md:mt-20 sm:mt-20 md:text-start sm:text-start">
                            <a href="<?php echo e(route('second', ['service', 'services'])); ?>" class="theme-btn8">
                                <span class="theme-btn8__shape"></span>
                                <span class="theme-btn8__shape"></span>
                                <span class="theme-btn8__shape"></span>
                                <span class="theme-btn8__shape"></span>
                ...
                <div class="row mt-30">
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="200">
                        <div class="service4-box mt-30">
                            ...
                            <div class="heading4 mt-20">
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Search Engine Optimization (SEO)</a></h4>
                                <p class="mt-16">Drive organic traffic and improve your online visibility with our advanced SEO techniques.</p>
                                <a href="<?php echo e(route('second', ['service', 'details1'])); ?>" class="learn text-16 leading-16 font-semibold title1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="300">
                        <div class="service4-box mt-30">
                            ...
                            <div class="heading4 mt-20">
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Pay-Per-Click Advertising (PPC)</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="400">
                        <div class="service4-box mt-30">
                            ...
                            <div class="heading4 mt-20">
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Content Marketing</a></h4>
                    ...
                    <div class="col-lg-6 col-md-6" data-aos="zoom-in-up" data-aos-duration="800" data-aos-delay="200">
                        <div class="service4-box mt-30">
                            ...
                            <div class="heading4 mt-20">
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Social Media Marketing (SMM)</a></h4>
                    ...
                    <div class="col-lg-6 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="300">
                        <div class="service4-box mt-30">
                            ...
                            <div class="heading4 mt-20">
                                <h4><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Web Design & Development</a></h4>
                            ...
                            <div class="testimonial2-slider-area">
                                <div class="rev_slider">
                                    <div class="rev_slide">
                                        ...
                                        <div class="text">
                                            <a href="<?php echo e(route('second', ['service', 'services'])); ?>" class="theme-btn8">Learn More</a>
                                            <div class="heading4 mt-20">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="vl-blog-4-content heading4">
                                        ...
                                        <h3><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">The Ultimate Guide to Scaling Your Business with Affiliate Marketing</a></h3>
                                        ...
                                        <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1100">
                        <div class="vl-blog-4-item add-bg mt-30">
                            ...
                            <div class="vl-blog-4-content heading4 mt-30">
                                ...
                                <h5><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Mastering Digital Marketing: Actionable Insights to Drive Real Results for Your Business</a></h5>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
                        <div class="vl-blog-4-item add-bg mt-30">
                            ...
                            <div class="vl-blog-4-content heading4 mt-30">
                                ...
                                <h5><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">The Future of Digital Marketing Trends Technologies Shaping Tomorrow’s Strategies</a></h5>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000">
                        <div class="vl-blog-4-item add-bg mt-30">
                            ...
                            <div class="vl-blog-4-content heading4 mt-30">
                                ...
                                <h5><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">From SEO to Social Media: Proven Techniques to Build Your Brand Online</a></h5>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.base', ['title' => '- Digital  Marketing', 'no' => 5, 'logo3' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/demo/index5.blade.php ENDPATH**/ ?>