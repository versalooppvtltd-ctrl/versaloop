                    ...
                    <div class="col-lg-6">
                        <div class="heading5 md:mt-30 sm:mt-30">
                            ...
                            <div class="button mt-30" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
                                <a class="theme-btn10" href="<?php echo e(route('second', ['pages', 'about'])); ?>">Learn More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000" data-aos="fade-left" data-aos-delay="200" data-duration="900">
                            <a class="theme-btn10" href="<?php echo e(route('second', ['service', 'services'])); ?>">View All Services <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="<?php echo e(route('second', ['pages', 'contact'])); ?>">Contact Us Now <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="team5 sp">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="<?php echo e(route('second', ['pages', 'team'])); ?>">Our Team Member <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
        ...
        <div class="tes6 sp sec-bg4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="<?php echo e(route('second', ['blogs', 'blog'])); ?>">View All Review <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="blog2 sp">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="<?php echo e(route('second', ['blogs', 'blog'])); ?>">See All Blogs <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
                    <div class="col-lg-6">
                        <div class="vl-blog-5-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-1-content heading5">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">5 Social Media Trends to Watch in 2025</a></h4>
                                <p class="mt-16">Discover the key trends shaping the social media landscape your brand can leverage them stay relevant.</p>
                                <a href="<?php echo e(route('second', ['blogs', 'details'])); ?>" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="vl-blog-5-item mt-30" data-aos="fade-up" data-aos-duration="900">
                            ...
                            <div class="vl-blog-1-content heading5">
                                ...
                                <h4><a href="<?php echo e(route('second', ['blogs', 'details'])); ?>">Maximizing ROI with Paid Social Ads</a></h4>
...
<?php echo $__env->make('layouts.base', ['title' => '- STARTUP AGENCY', 'no' => 1, 'logo3' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/demo/index3.blade.php ENDPATH**/ ?>