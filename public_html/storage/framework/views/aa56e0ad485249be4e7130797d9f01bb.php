                ...
                <div class="row mt-30">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="200">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Startup Support</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="300">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">HR Staffing Excellence</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Solar Energy Solutions:</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="300">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Real Estate Expertise</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Advertising & Branding</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">E-Commerce Optimization</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">travel Guide Expertise</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="<?php echo e(route('second', ['service', 'details1'])); ?>">Insurance Policy</a></h5>
...
<?php echo $__env->make('layouts.base', ['title' => '|| About Us'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/dell/repos/laravel_project/themeforest-GdkAJN7n-seox-seo-digital-marketing-agency-laravel-12-template/SEOX-LARAVEL_v1.0/SEOX/resources/views/about-us/mission-vision.blade.php ENDPATH**/ ?>